...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Ksidhdnkddbos/ZTele"
    )
    ...
    # For updater plugin
    UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "zizi")
    ...
    OLDZED_REPO = os.environ.get("OLDZED_REPO", "https://github.com/Ksidhdnkddbos/ZTele")
    if OLDZED_REPO and not url(OLDZED_REPO):
        OLDZED_REPO = "https://github.com/TheZT-hon/ZTele"
